...
// === CATEGORIES ===
export type CategorySlug = "epp" | "limpieza" | "fumigacion" | "ferreteria" | "cuidado-personal" | "salud-ocupacional";
...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    subtitle: "Equipos de protección, ropa de trabajo y suministros de seguridad",
...
export const SUBCATEGORY_ORDER: Record<CategorySlug, string[]> = {
  epp: ["Botas de Seguridad", "Zapatos de Seguridad", "Cascos y Mascarillas", "Zuecos EVACOL"],
  limpieza: ["Limpiadores IONICS", "Línea Industrial IONICS", "Papel y Sanitización", "Aerosoles y Lubricantes", "Detergentes y Jabones", "Suministros y Herramientas"],
  fumigacion: ["Equipos de Fumigación"],
  ferreteria: ["Detectores y Herramientas"],
  "cuidado-personal": ["Cuidado de Piel", "Tratamientos Capilares"],
  "salud-ocupacional": ["Guantes de Protección", "Calzado de Seguridad", "Ropa de Trabajo", "Protección Visual y Facial", "Protección Cabeza, Respiratoria y Auditiva", "Accesorios y Botiquines"],
};
...
export const PRODUCTS: Product[] = [
  // --- EPP: Botas ---
  { id: "bota-1", name: "Bota PVC Industrial Titus", category: "epp", subcategory: "Botas de Seguridad", brand: "Carpi", image: "/images/botas/bota1.webp", altText: "Bota PVC de seguridad industrial Carpi modelo Titus" },
  { id: "bota-2", name: "Bota de Seguridad Reforzada", category: "epp", subcategory: "Botas de Seguridad", brand: "Carpi", image: "/images/botas/bota2.webp", altText: "Bota de seguridad industrial reforzada Carpi" },
  { id: "bota-3", name: "Bota Industrial Resistente", category: "epp", subcategory: "Botas de Seguridad", brand: "Carpi", image: "/images/botas/bota3.webp", altText: "Bota industrial resistente a químicos Carpi" },

  // --- EPP: Zapatos DeWalt ---
  { id: "zapato-1", name: "DeWalt Kirksville", category: "epp", subcategory: "Zapatos de Seguridad", brand: "DeWalt", image: "/images/zapatos/zapatos1.webp", altText: "Zapato de seguridad DeWalt Kirksville con puntera de aluminio", featured: true },
  { id: "zapato-2", name: "DeWalt Shelton", category: "epp", subcategory: "Zapatos de Seguridad", brand: "DeWalt", image: "/images/zapatos/zapatos2.webp", altText: "Zapato de seguridad DeWalt Shelton resistente al agua" },
  { id: "zapato-3", name: "DeWalt Hadley", category: "epp", subcategory: "Zapatos de Seguridad", brand: "DeWalt", image: "/images/zapatos/zapatos3.webp", altText: "Zapato de seguridad DeWalt Hadley con suela antideslizante" },
  { id: "zapato-4", name: "DeWalt Manvel", category: "epp", subcategory: "Zapatos de Seguridad", brand: "DeWalt", image: "/images/zapatos/zapatos4.webp", altText: "Zapato de seguridad DeWalt Manvel con puntera compuesta" },
  { id: "zapato-5", name: "DeWalt Corinth", category: "epp", subcategory: "Zapatos de Seguridad", brand: "DeWalt", image: "/images/zapatos/zapatos5.webp", altText: "Zapato de seguridad DeWalt Corinth tipo bota" },
  { id: "zapato-6", name: "DeWalt Clemente", category: "epp", subcategory: "Zapatos de Seguridad", brand: "DeWalt", image: "/images/zapatos/zapatos6.webp", altText: "Zapato de seguridad DeWalt Clemente liviano" },
  { id: "zapato-7", name: "DeWalt Pro Series", category: "epp", subcategory: "Zapatos de Seguridad", brand: "DeWalt", image: "/images/zapatos/zapatos7.webp", altText: "Zapato de seguridad DeWalt serie profesional" },

  // --- EPP: Seguridad ---
  { id: "casco-1", name: "Casco de Seguridad ANSI", category: "epp", subcategory: "Cascos y Mascarillas", brand: "CTS", image: "/images/seguridad/casco-seguridad.webp", altText: "Casco de seguridad industrial con visera y certificación ANSI" },
  { id: "mascara-1", name: "Máscara de Protección Respiratoria", category: "epp", subcategory: "Cascos y Mascarillas", brand: "CTS", image: "/images/seguridad/mascara.webp", altText: "Máscara de protección respiratoria industrial con filtros" },

  // --- EPP: EVACOL ---
  { id: "evacol-1", name: "Zueco EVACOL 080", category: "epp", subcategory: "Zuecos EVACOL", brand: "EVACOL", image: "/images/evacol/evacol1.webp", altText: "Zueco antideslizante EVACOL 080 para cocina industrial" },
  { id: "evacol-2", name: "Zueco EVACOL Cerrado", category: "epp", subcategory: "Zuecos EVACOL", brand: "EVACOL", image: "/images/evacol/evacol2.webp", altText: "Zueco cerrado EVACOL antideslizante para hospitales" },
  { id: "evacol-3", name: "Zueco EVACOL Sport", category: "epp", subcategory: "Zuecos EVACOL", brand: "EVACOL", image: "/images/evacol/evacol3.webp", altText: "Zueco EVACOL línea Sport ergonómico" },
  { id: "evacol-4", name: "Zueco EVACOL Pro", category: "epp", subcategory: "Zuecos EVACOL", brand: "EVACOL", image: "/images/evacol/evacol4.webp", altText: "Zueco profesional EVACOL con suela antideslizante certificada" },
  { id: "evacol-5", name: "Zueco EVACOL Classic", category: "epp", subcategory: "Zuecos EVACOL", brand: "EVACOL", image: "/images/evacol/evacol5.webp", altText: "Zueco EVACOL línea clásica para uso diario" },
  { id: "evacol-6", name: "Zueco EVACOL Comfort", category: "epp", subcategory: "Zuecos EVACOL", brand: "EVACOL", image: "/images/evacol/evacol6.webp", altText: "Zueco EVACOL Comfort con plantilla ergonómica" },
  { id: "evacol-7", name: "Zueco EVACOL Industrial", category: "epp", subcategory: "Zuecos EVACOL", brand: "EVACOL", image: "/images/evacol/evacol7.webp", altText: "Zueco EVACOL para uso industrial y laboratorio" },
  { id: "evacol-8", name: "Zueco EVACOL Kitchen", category: "epp", subcategory: "Zuecos EVACOL", brand: "EVACOL", image: "/images/evacol/evacol8.webp", altText: "Zueco EVACOL especial para cocinas profesionales" },
  ...
  // --- Cuidado Personal ---
  { id: "crema-1", name: "Crema Antioxidante Senior+Plus", category: "cuidado-personal", subcategory: "Cuidado de Piel", brand: "Senior+Plus", image: "/images/cremas/crema1.webp", altText: "Crema corporal antioxidante Senior+Plus para adultos mayores", price: "₡7,065", featured: true },
  { id: "crema-2", name: "Aceite en Gel Senior+Plus", category: "cuidado-personal", subcategory: "Cuidado de Piel", brand: "Senior+Plus", image: "/images/cremas/crema2.webp", altText: "Aceite en gel hidratante Senior+Plus para piel madura", price: "₡4,485", featured: true },
  { id: "crema-3", name: "Kératine Lisos Try Me", category: "cuidado-personal", subcategory: "Tratamientos Capilares", brand: "Try Me", image: "/images/cremas/crema3.webp", altText: "Tratamiento capilar Kératine Lisos Try Me para cabello liso", price: "₡3,720", featured: true },
  { id: "crema-4", name: "Kératine Rizos Try Me", category: "cuidado-personal", subcategory: "Tratamientos Capilares", brand: "Try Me", image: "/images/cremas/crema4.webp", altText: "Tratamiento capilar Kératine Rizos Try Me para cabello rizado", price: "₡3,720" },
  { id: "crema-5", name: "Colesterol Repair Try Me", category: "cuidado-personal", subcategory: "Tratamientos Capilares", brand: "Try Me", image: "/images/cremas/crema5.webp", altText: "Mascarilla capilar Colesterol Intensive Repair Try Me", price: "₡2,330" },
  { id: "pronto-crema", name: "Colesterol Capilar Try Me", category: "cuidado-personal", subcategory: "Tratamientos Capilares", brand: "Try Me", image: "/images/cremas/pronto-crema.webp", altText: "Colesterol capilar restaurador Try Me acción rápida", price: "₡2,330" },

  // --- Ferretería ---
  { id: "detector-1", name: "Detector de Tormentas SkyScan", category: "ferreteria", subcategory: "Detectores y Herramientas", brand: "IONICS", image: "/images/detectores/detector1.webp", altText: "Detector de tormentas y rayos SkyScan Storm Pro con pantalla LCD", featured: true },
  { id: "detector-2", name: "Detector Portátil de Rayos", category: "ferreteria", subcategory: "Detectores y Herramientas", brand: "IONICS", image: "/images/detectores/detector2.webp", altText: "Detector portátil de rayos y tormentas eléctricas" },
  { id: "detector-3", name: "Detector de Tormentas Pro", category: "ferreteria", subcategory: "Detectores y Herramientas", brand: "IONICS", image: "/images/detectores/detector3.webp", altText: "Detector profesional de tormentas con alerta temprana" },

  // --- Fumigación ---
  { id: "bomba-18l", name: "Bomba Fumigadora 18L", category: "fumigacion", subcategory: "Equipos de Fumigación", brand: "CTS", image: "/images/fumigacion/bombaveneno18litros.webp", altText: "Bomba fumigadora tipo espalda de 18 litros profesional" },
  { id: "repelente-flix", name: "Repelente FLIX Elmerc", category: "fumigacion", subcategory: "Equipos de Fumigación", brand: "Elmerc", image: "/images/fumigacion/repelente.webp", altText: "Repelente de insectos profesional FLIX de Elmerc", featured: true },
  { id: "silicone-pro", name: "Silicone Sellador Pro", category: "fumigacion", subcategory: "Equipos de Fumigación", brand: "CTS", image: "/images/fumigacion/silicone.webp", altText: "Sellador de silicona profesional para uso industrial" },
