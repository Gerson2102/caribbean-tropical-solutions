...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <motion.a
      ...
      className={`group block overflow-hidden rounded-2xl border bg-[#f7f6f3] transition-shadow duration-300 hover:shadow-lg ${product.featured ? "border-accent/30 ring-1 ring-accent/20" : "border-charcoal/[0.06]"}`}
